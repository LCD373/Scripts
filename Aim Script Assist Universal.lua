...
local Script_Title = "Universal <font color=\"rgb(255, 69, 0)\">|</font> Aim"
...
Img_2.Text = "^"
Img_2.TextColor3 = Color3.fromRGB(255, 69, 0)
...
local toggleBtn
toggleBtn = addToggle("Toggle Aim Assist", function(state)
	enabled = state
end, false)

local toggleTeamCheckBtn
toggleTeamCheckBtn = addToggle("Only Target enemies", function(state)
	teamcheck = state
end)

local aimPartCombo
aimPartCombo = addComboBox("Where to Aim", {"Head", "Torso"}, function(selection)
	aimpart = selection
end)
